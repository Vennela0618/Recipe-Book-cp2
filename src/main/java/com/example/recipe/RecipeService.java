...
public class RecipeService implements RecipeRepository {
        ...
        public ArrayList<Recipe> getRecipes(){
          ArrayList<Recipe> recipesList = new ArrayList<>(recipeBook.values());
          return recipesList;
        }
        ...
        Recipe existingRecipe = recipeBook.get(recipeId);
          if (existingRecipe == null) throw new ResponseStatusException(HttpStatus.NOT_FOUND);
          if (recipe.getRecipeName()!= null) existingRecipe.setRecipeName(recipe.getRecipeName());
          if(recipe.getRecipeType() != null) existingRecipe.setRecipeType(recipe.getRecipeType());
          if (recipe.getIngredients()!= null) existingRecipe.setIngredients(recipe.getIngredients());
